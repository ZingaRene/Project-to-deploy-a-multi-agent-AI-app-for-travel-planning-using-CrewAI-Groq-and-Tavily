...
st.set_page_config(page_title = "Zinga René", page_icon = ":100:", layout = "wide")
...
with col_box:
    st.markdown(
        "<div style='border:1px solid #ccc; padding:6px 10px; border-radius:6px; text-align:center;'>Projecto Feito com Orientação da DSA</div>",
        unsafe_allow_html=True
    )
